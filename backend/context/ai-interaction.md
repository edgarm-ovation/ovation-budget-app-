...
**Whenever a commit changes `prisma/schema.prisma`, flag the prod `db push` (step 8) before considering the work shipped — never assume the deploy migrates prod.**
