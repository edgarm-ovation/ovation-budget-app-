...
5. Execute the research using appropriate tools:
   - Read files (.NET API models/services in `../Backend/Ovation.Api`, the `Ovation-Docs/` docs, frontend types/components)
   - Consult `Ovation-Docs/docs/database/schema.md` for the data model (no DB MCP — the .NET 8 API owns persistence)
...
- Output should go to `Ovation-Docs/docs/` (or the path the prompt specifies) unless otherwise specified
