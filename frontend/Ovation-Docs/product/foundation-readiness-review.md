...
| Tech stack | Mostly defined | Good | Next.js, TypeScript, Tailwind (custom UI primitives), TanStack Table/Query, Zustand, .NET 8, EF Core, Azure SQL, Blob Storage, and Azure AD are a reasonable foundation. |
...
| UI | Tailwind CSS (custom, hand-built primitives) | Fast to build clean operational UI without locking into a component library. |
